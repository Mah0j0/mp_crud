...
Future<List> getProductos() async { //funcion asincrona, o sea que se ejecuta en segundo plano
  List productos = [];
  QuerySnapshot queryProductos = await db.collection('productos').get(); //obtenemos los productos, TODOS LOS QUE HAYA
  for (var doc in queryProductos.docs) { //recorremos los productos
